...
export default function Streaming() {
  ...
  const youtubeThumb = (dark: boolean) => (dark ? '/assets/streaming/youtube-thumbnail-dark.jpg' : '/assets/streaming/youtube-thumbnail-dark.jpg');
  const twitchThumb = (dark: boolean) => (dark ? '/assets/streaming/twitch-thumbnail-dark.jpg' : '/assets/streaming/twitch-thumbnail-dark.jpg');
      ...
      <div className="streaming-layout md:flex md:gap-6 mb-12">
        ...
        <section className="youtube rounded border border-theme-accent dark:border-theme-accent-dark bg-theme-card dark:bg-theme-card-dark p-6 flex-1 mb-6 md:mb-0">
          ...
          <a href="https://www.youtube.com/@MungDaal321" target="_blank" rel="noreferrer" className="block mb-4 group">
            <img loading="lazy" decoding="async" src={youtubeThumb(isDark)} alt="YouTube Channel" className="w-full rounded-lg transition-shadow" onError={(e) => { (e.currentTarget as HTMLImageElement).src = '/images/placeholder.svg'; }} />
          </a>
        ...
        <section className="twitch rounded border border-theme-accent dark:border-theme-accent-dark bg-theme-card dark:bg-theme-card-dark p-6 flex-1">
          ...
          <a href="https://www.twitch.tv/mungdaal321" target="_blank" rel="noreferrer" className="block mb-4 group">
            <img loading="lazy" decoding="async" src={twitchThumb(isDark)} alt="Twitch Channel" className="w-full rounded-lg transition-shadow" onError={(e) => { (e.currentTarget as HTMLImageElement).src = '/images/placeholder.svg'; }} />
          </a>
